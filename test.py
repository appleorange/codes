...
def test_single_activity_accuracy_all_correct():
    ...
    accuracy, mismatched_indices, mismatched_names, mismatched_names_details = single_activity_accuracy(outputs, labels)
    ...
    print(f"Mismatched names details: {mismatched_names_details}")
...
def test_single_activity_accuracy_half_correct():
    ...
    accuracy, mismatched_indices, mismatched_names, mismatched_names_details = single_activity_accuracy(outputs, labels, debugging_details=True, image_names=names)
    print(f"Mismatched indices: {mismatched_indices}")
...
def test_single_activity_accuracy_half_correct_with_confusion_matrix():
    ...
    accuracy, mismatched_indices, mismatched_names, mismatched_names_details = single_activity_accuracy(outputs, labels, confusion_matrix_metric)
    ...
    print(f"mismatched_names_details: {mismatched_names_details}")
